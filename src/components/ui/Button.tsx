...
const Button = ({
  ...
  const variantClasses = {
    ...
    outline: 'border border-gray-300 bg-transparent hover:bg-gray-50 text-gray-700 focus:ring-primary/40',
    ghost: 'bg-transparent hover:bg-gray-100 text-gray-700 focus:ring-gray-500/40',
  };
